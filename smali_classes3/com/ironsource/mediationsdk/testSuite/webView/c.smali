.class public final Lcom/ironsource/mediationsdk/testSuite/webView/c;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/ironsource/mediationsdk/testSuite/webView/c;",
        "Ln/b;",
        ...
        "jsonData",
        "<init>",
        "(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Ln/a;Lorg/json/JSONObject;Ljava/lang/String;)V",
...
# direct methods
.method public static synthetic $r8$lambda$65hjnEIzv8SCcBwRMFUGjEsW79w(Lcom/ironsource/mediationsdk/testSuite/webView/c;Ljava/lang/String;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/ironsource/mediationsdk/testSuite/webView/c;->a(Lcom/ironsource/mediationsdk/testSuite/webView/c;Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic $r8$lambda$UwTs3Fbhezmm-RRNay7wnnmAcag(Ln/a;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/mediationsdk/testSuite/webView/c;->a(Ln/a;)V

    return-void
.end method

.method public static synthetic $r8$lambda$cD9uqy2FMgLduI8ZmrCsJM9k_0s(Lcom/ironsource/mediationsdk/testSuite/webView/c;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/mediationsdk/testSuite/webView/c;->e(Lcom/ironsource/mediationsdk/testSuite/webView/c;)V

    return-void
.end method

.method public constructor <init>(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Ln/a;Lorg/json/JSONObject;Ljava/lang/String;)V
    .locals 2
    ...
    iput-object v0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->a:Landroid/os/Handler;

    new-instance v0, Landroid/webkit/WebView;

    invoke-direct {v0, p1}, Landroid/webkit/WebView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->b:Landroid/webkit/WebView;

    new-instance v0, Landroid/webkit/WebView;

    invoke-direct {v0, p1}, Landroid/webkit/WebView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->c:Landroid/webkit/WebView;

    iput-object p3, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->d:Lorg/json/JSONObject;

    invoke-direct {p0, p1, p2, p4}, Lcom/ironsource/mediationsdk/testSuite/webView/c;->a(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Ln/a;Ljava/lang/String;)V

    return-void
.end method

.method public static final synthetic a(Lcom/ironsource/mediationsdk/testSuite/webView/c;)Landroid/os/Handler;
    .locals 0

    iget-object p0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->a:Landroid/os/Handler;

    return-object p0
.end method

.method private final a(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Ln/a;Ljava/lang/String;)V
    .locals 4

    iget-object v0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->b:Landroid/webkit/WebView;
    ...
    :goto_1
    iget-object v0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->c:Landroid/webkit/WebView;
    ...
    iget-object v2, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->a:Landroid/os/Handler;

    invoke-direct {v0, p1, v2}, Lcom/ironsource/mediationsdk/testSuite/a;-><init>(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Landroid/os/Handler;)V

    new-instance p1, Lcom/ironsource/mediationsdk/testSuite/webView/c$b;

    invoke-direct {p1, p0, p2}, Lcom/ironsource/mediationsdk/testSuite/webView/c$b;-><init>(Lcom/ironsource/mediationsdk/testSuite/webView/c;Ln/a;)V

    iget-object v2, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->c:Landroid/webkit/WebView;

    new-instance v3, Lcom/ironsource/mediationsdk/testSuite/webView/a;

    invoke-direct {v3, v0, p1, p0}, Lcom/ironsource/mediationsdk/testSuite/webView/a;-><init>(Lcom/ironsource/mediationsdk/testSuite/a;Ln/a;Ln/b;)V
    ...
    iget-object p1, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->c:Landroid/webkit/WebView;

    new-instance v0, Lcom/ironsource/mediationsdk/testSuite/webView/c$a;

    invoke-direct {v0, p0, p3}, Lcom/ironsource/mediationsdk/testSuite/webView/c$a;-><init>(Lcom/ironsource/mediationsdk/testSuite/webView/c;Ljava/lang/String;)V
    ...
    :cond_4
    iget-object p1, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->b:Landroid/webkit/WebView;
    ...
    :cond_5
    iget-object p1, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->a:Landroid/os/Handler;

    new-instance p3, Lcom/ironsource/mediationsdk/testSuite/webView/c$$ExternalSyntheticLambda0;

    invoke-direct {p3, p0}, Lcom/ironsource/mediationsdk/testSuite/webView/c$$ExternalSyntheticLambda0;-><init>(Lcom/ironsource/mediationsdk/testSuite/webView/c;)V
    ...
    new-instance p3, Lcom/ironsource/mediationsdk/testSuite/webView/c$$ExternalSyntheticLambda2;

    invoke-direct {p3, p2}, Lcom/ironsource/mediationsdk/testSuite/webView/c$$ExternalSyntheticLambda2;-><init>(Ln/a;)V
...
.method private static final a(Lcom/ironsource/mediationsdk/testSuite/webView/c;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object p0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->c:Landroid/webkit/WebView;
...
.method public static final synthetic a(Lcom/ironsource/mediationsdk/testSuite/webView/c;Z)V
    .locals 0

    iput-boolean p1, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->e:Z

    return-void
.end method

.method private static final a(Ln/a;)V
    .locals 1
    ...
    invoke-interface {p0}, Ln/a;->onUIReady()V

    return-void
.end method

.method public static final synthetic b(Lcom/ironsource/mediationsdk/testSuite/webView/c;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->e:Z

    return p0
.end method

.method public static final synthetic c(Lcom/ironsource/mediationsdk/testSuite/webView/c;)Lorg/json/JSONObject;
    .locals 0

    iget-object p0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->d:Lorg/json/JSONObject;

    return-object p0
.end method

.method public static final synthetic d(Lcom/ironsource/mediationsdk/testSuite/webView/c;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->f:Z

    return p0
.end method

.method private static final e(Lcom/ironsource/mediationsdk/testSuite/webView/c;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->f:Z
...
.method public final a(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p2}, Lo/a;->b(Ljava/util/List;)Ljava/lang/String;
...
.method public final a()V
    ...
    invoke-virtual {p0}, Lcom/ironsource/mediationsdk/testSuite/webView/c;->b()V
...
.method public final a(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->a:Landroid/os/Handler;

    new-instance v1, Lcom/ironsource/mediationsdk/testSuite/webView/c$$ExternalSyntheticLambda1;

    invoke-direct {v1, p0, p1}, Lcom/ironsource/mediationsdk/testSuite/webView/c$$ExternalSyntheticLambda1;-><init>(Lcom/ironsource/mediationsdk/testSuite/webView/c;Ljava/lang/String;)V
...
.method public a(Ljava/lang/String;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;Ljava/util/List;)V
    ...
    iget-boolean v0, p0, Lcom/ironsource/mediationsdk/testSuite/webView/c;->e:Z
    ...
    invoke-virtual {p0, p2, p1}, Lcom/ironsource/mediationsdk/testSuite/webView/c;->a(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/ironsource/mediationsdk/testSuite/webView/c;->a(Ljava/lang/String;)V
